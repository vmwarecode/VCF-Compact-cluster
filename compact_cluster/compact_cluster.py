...
def compact_cluser(hostname,username,password,cluster_id):
    data = read_input()
...
def read_input():
    with open('cluster_compaction_spec.json') as json_file:
...
def action_performer():
    ...
    compact_cluster(hostname,username,password,cluster_id)
    return
